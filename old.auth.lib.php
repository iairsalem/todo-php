...
class OneFileLoginApplication
{
    ...
    public function __construct()
    {
        ...
        $this->db_sqlite_path = $config['db_sqlite_path'];
        ...
        if ($this->performMinimumRequirementsCheck()) {
            ...
            die ('houston, server is not compatible');
        }
    }
    ...
    public function requireAdmin(){
        if($this->runApplication()){
            if($this->is_admin){
                ...
                if($this->user_is_logged_in){
                    $this->feedback = "admin user required";
                }
                $this->showPageLoginForm();
                return false;
            }
    ...
    public function showPageLoginForm()
    {
        ...
        echo '<form method="post" action="' . $this->login_page . '" name="loginform">';
        ...
        echo "<input type='hidden' name='_token' style='display:none;' value='{$_SESSION["_token"]}' /> ";
        echo '<input type="submit" name="login" value="Log in" />';
        echo '</form>';
        echo '<a href="' . $this->register_page . '?action=register">Register new account</a>';
    }
    ...
    public function showPageRegistration()
    {
        ...
        echo '<form method="post" action="' . $this->register_page . '?action=register" name="registerform">';
        ...
        echo '</form>';
        echo '<a href="' . $this->homepage . '">Homepage</a>';
    }
}
